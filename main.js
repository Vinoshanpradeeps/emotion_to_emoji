...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/0n8AD_kez/model.json',modelLoaded);
...
function gotResult(error, results){
    if (error) {
        ...
        {
            document.getElementById("uodate_emoji_2").innerHTML = "&#128532;";
        }
